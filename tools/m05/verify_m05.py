...
from m10_scope import is_public_m10_path
...
def validate_descendant_paths(paths) -> None:
    exact = {
        ...
        ".github/workflows/m07r6-subsystem-fdc-command-gate.yml",
        ...
        "qa/golden/m07r6-public-status.sha256",
        ...
        "schema/m07r6-public-status.schema.json",
        "docs/porting/m07r5-firmware-no-request-gate.md",
        "docs/porting/m07r6-subsystem-fdc-command-gate.md",
    }
    prefixes = (
        "config/m05/", "tests/m05/", "tools/m05/", "config/m06/",
        "docs/porting/m06-", "tests/m06/", "tools/m06/", "config/m07/",
        "docs/porting/m07-", "docs/porting/m07r3-", "schema/m07-", "schema/m07r3-",
    ...
    for relative in sorted(item for item in paths if item):
        if is_public_m09_path(relative) or is_public_m10_path(relative):
            continue
