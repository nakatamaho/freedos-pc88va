...
"""Compose M10 public media with the accepted loader extent reserved."""
import argparse
import hashlib
import json
...
sys.path[:0] = [str(ROOT / "components/fdkernel/pc88va/tools"), str(ROOT / "tools/m10")]
...
def main():
    ...
    raw, d88, composition = compose(spec, records, stage2, stage1, {510: False, 1022: False}, accepted)
    ...
    print("M10 public media composed; M08 loader and unchanged payload identities verified")
