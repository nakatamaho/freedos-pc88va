...
"""M16-maintained ROM-free checks for the linked M13 placement contract."""
...
class PlacementTests(unittest.TestCase):
    ...
    def test_va_fixed_loader_profile_is_source_bound(self):
        profile_path = ROOT / 'config/m16/va-fixed-loader-profile-test.json'
        profile = json.loads(profile_path.read_text())
        loader_tools = ROOT / 'tools/m16'
